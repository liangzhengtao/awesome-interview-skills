...
[![Skills](https://img.shields.io/badge/skills-14-blueviolet)](#技能列表)
...
*这些是 AI 技能（`.md` 文件），可以加载到 **Cursor**、**Claude Code**、**Kimi Code**、**Windsurf** 或任何 AI 编码助手中，获得实时面试辅导。*
...
请参阅 [SECURITY.md](SECURITY.md) 了解安全政策。
...
- [awesome-interview-skills](https://github.com/liangzhengtao/awesome-interview-skills) — 🎯 本仓库！14 个面试准备 AI 技能
- [awesome-ai-writing-skills](https://github.com/liangzhengtao/awesome-ai-writing-skills) — ✍️ 学术和专业写作 AI 技能
- [awesome-ai-coding-skills](https://github.com/liangzhengtao/awesome-ai-coding-skills) — 💻 软件开发工作流 AI 技能
- [awesome-ai-research-skills](https://github.com/liangzhengtao/awesome-ai-research-skills) — 🔬 研究和文献综述 AI 技能
